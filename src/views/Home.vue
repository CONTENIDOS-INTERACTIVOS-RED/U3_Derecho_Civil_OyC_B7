        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los orígenes del Derecho, el contrato ha sido una de las herramientas más importantes para regular las relaciones jurídicas entre particulares. En esta tercera unidad, nos adentraremos en las distintas clases de contratos reconocidas por el ordenamiento jurídico colombiano, con especial énfasis en aquellos que más frecuentemente se presentan en la vida cotidiana y en el ejercicio profesional del Derecho. 
              
              p #[b ¡Prepárese para comprender a fondo la función de los contratos como fuente de obligaciones y su papel clave en la práctica jurídica civil!]
